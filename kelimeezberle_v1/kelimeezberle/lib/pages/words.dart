    ...
    return InkWell(
      ...
      child: Center(
              child: Container(
                ...
                child: Card(
                  color: pressController!=true?Color(fastMethodColor.HexaColorConverter("#DCD2FF")):Color(fastMethodColor.HexaColorConverter("#E7E3F5")),
                  elevation: 8,
                      ...
                      Column(
                        ...
                        children: [
                          Container(margin: EdgeInsets.only(left: 15, top: 10),
                            child: Text(word_tr!, style: TextStyle(
                                color: Colors.black,
                                fontSize: 18,
                          ...
                          Container(margin: EdgeInsets.only(left: 30, bottom: 10),
                            child: Text(word_eng!, style: TextStyle(
                                color: Colors.black,
                                fontSize: 16,
